    ...
    const htmlContent = `
      <div style="font-family: Arial, sans-serif; max-width: 520px; margin: auto; background: #0b0e1f; color: #fff; border-radius: 12px; overflow: hidden; border: 1px solid rgba(124,77,255,0.3);">
        ...
        <div style="padding: 24px 28px;">
          ...
          <div style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 16px; font-size: 15px; line-height: 1.6; white-space: pre-wrap; color: #fff;">${message}</div>
        </div>
